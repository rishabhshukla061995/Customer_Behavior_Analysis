...
SELECT shipping_type,
    ROUND(AVG(purchase_amount::numeric),2) as avg_purchase_amt
FROM customer
...
WITH item_count AS(
    SELECT category,
        item_purchased,COUNT(item_purchased) as total_purchases,
        DENSE_RANK() OVER(PARTITION BY category ORDER BY COUNT(item_purchased)) as item_rank
		FROM customer
